...
def makeFile(nbrhood):
    ...
    titleString = "id=\"Neighborhood Title\">College Mentorship - Khan's Tutorial</title>"
    bannerString = "id=\"Neighborhood 1\">College Mentorship</h1>"
    featureString = "Why do families choose Khan's"
    newTString = titleString.replace("College Mentorship - Khan's Tutorial</title>",nbrhood.replace('-',' ')+" College Mentorship - Khan's Tutorial</title>")
    newBString = bannerString.replace("College Mentorship</h1>",nbrhood.replace('-',' ')+" College Mentorship</h1>")
